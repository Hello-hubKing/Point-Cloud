...
class Convlayer(nn.Module):
    def __init__(self, point_scales):
        ...
        self.con_fuse1=nn.Sequential(nn.Conv1d(1280,1280,1),nn.BatchNorm1d(1280),nn.ReLU())
        self.con_fuse2=nn.Sequential(nn.Conv1d(640,640,1),nn.BatchNorm1d(640),nn.ReLU())
    ...
    def forward(self, x):
        ...
        x_1=self.con_fuse2(x_1)
        x_2=self.con_fuse1(x_2)
